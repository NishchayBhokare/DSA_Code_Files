...
using namespace std;
    ...
    //Approach 1- using sorting and while loop TC- O(nlogn) , SC-O(1)
    ...
    //Approach 2- using minheap TC-O(logn) SC- O(n);
    // int kthSmallest(int arr[], int l, int r, int k) {
    ...
    //Approach 3- most efficient approach using max heap. TC- O(logn) SC- O(k);
